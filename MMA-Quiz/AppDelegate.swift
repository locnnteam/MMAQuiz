...
//  MMA-Quiz
//
//  Created by Nguyen Nhat  Loc on 11/25/17.
...
class AppDelegate: UIResponder, UIApplicationDelegate, GADInterstitialDelegate{
    ...
    lazy var rankingVC: GameCenterController = {
        return GameCenterController(nibName: "GameCenterController", bundle: nil)
    }()
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        //TabarView
        homeVC.title = "Picture Quiz"
        homeVC.isMainView = true
        homeVC.tabBarItem = UITabBarItem(title: "Picture", image: #imageLiteral(resourceName: "picture_pickup"), selectedImage: #imageLiteral(resourceName: "picture_pickup"))
        
        homeTypingVC.title = "Typing Quiz"
        homeTypingVC.isMainView = false
        homeTypingVC.tabBarItem = UITabBarItem(title: "Typing", image: #imageLiteral(resourceName: "typing"), selectedImage: #imageLiteral(resourceName: "typing"))
        
        rankingVC.title = "Ranking"
        rankingVC.tabBarItem = UITabBarItem(title: "Ranking", image: #imageLiteral(resourceName: "ranking"), selectedImage: #imageLiteral(resourceName: "ranking"))
        
//        settingsVC.title = "Settings"
//        settingsVC.tabBarItem = UITabBarItem(tabBarSystemItem: .more, tag: 3)
        
        let controllers = [homeVC, homeTypingVC, rankingVC] as [Any]
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "MMA_Quiz")
