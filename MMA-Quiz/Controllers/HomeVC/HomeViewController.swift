...
class HomeViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout, DownloadFileDelegate, HeaderMainViewDelegate, LessonViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let blurredImage = #imageLiteral(resourceName: "home_bg").applyBlur(
            withRadius: CGFloat(0.3),
            tintColor: UIColor.init(white: 0.0, alpha: 0.3),
...
//        self.view.backgroundColor = UIColor(patternImage: #imageLiteral(resourceName: "home_bg"))
